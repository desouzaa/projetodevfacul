    ...
    <div class="col-xs-12 col-sm-12 col-md-11 col-lg-10 col-xl-10 col-xxl-10 mx-auto">
        <div class="card shadow-none">
            ...
            <div class="card-body p-xs-0 p-sm-2 p-lg-5 p-md-5">
                <h2 class="mb-4" style="text-align: center;">Raças Cadastradas</h2>
            ...
            <table id="tableracas" class="table table-striped table-hover text-center">
                <thead>
                  <tr>
                    <th scope="col">ID</th>
                ...
                @forelse($racas as $raca)
                  <tr>
                    ...
                    <td><form action="/excluirraca/{{$raca->id}}" method="POST">
                      @csrf
                      @method('DELETE')
                    
                 <button class="btn btn-danger" type="submit" onclick="return confirm('Tem certeza que deseja deletar esta Raça?')">Excluir</button>
                    </td>
                    </form></td>
               ...
               @empty
                  <tr><td colspan="4"> Nenhuma Raça cadastrada</td></tr>
                 
                  @endforelse
                </tbody>
              </table>
            </div>
            <div class="mxauto text-center mt-5"><a class="btn btn-secondary" href="/cadastrarraca">Cadastrar Nova Raça</a></div>
            </div>
        </div>
    </div>
</div>
