...
<head>
  <title>Login -  Banho e tosa</title>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    ...
    <body onload="quadro()" class="bg-dark">
        ...
        <div class="container-fluid d-flex flex-column justify-content-center align-items-center bg-dark">
            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-8 col-sm-12 col-xs-12 ">
                <div style="margin-top: 5%" class="p-2 bg-light mb-5 text-light form-signin card p-4 border-rounded rounded-3 shadow-lg text-center">
                    ...
                    <h1 class="h3 fs-1 fw-bold text-dark ">HOUNDS</h1>
                    <h6 class="h3 mb-5 fw-bold text-dark fs-4 fw-lighter">Banho e tosa</h6>
                    
                    @if(session('msg'))   
                    <div id="msg" class="alert alert-danger text-center mx-auto" role="alert">{{session('msg')}}</div>
                    @endif
                    ...
                    <p class="mt-5 mb-3 text-muted">© Hounds Banho e tosa:
                        <a style="text-decoration: none;" class="text-muted" href="">Desenvolvido por
                        <strong>
                            <a class="text-muted" target="_blank"href="https://www.linkedin.com/in/rafael-de-souza-7a96a41a6">Gangland Tech</a>
                        </strong>
                    </a>
                </p>
                    </form>
